...
import com.odilium.ticket.management.repository.TicketInformationRepository;
...
@Configuration
@EnableBinding({MongoChannel.class, RedisChannel.class})
@IntegrationComponentScan
@EnableRedisRepositories(basePackageClasses = TicketInformationRepository.class)
@EnableSwagger2
public class TicketManagerGatewayConfiguration {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Odilum Ticket Manager")
                .description("Ticket Manager Gateway")
                .termsOfServiceUrl("")
                .license("")
                .licenseUrl("")
                .version("1.0")
