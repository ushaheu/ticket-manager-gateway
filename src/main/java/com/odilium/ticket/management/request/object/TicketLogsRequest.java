...
public class TicketLogsRequest {
    ...
    public TicketLogsRequest() {
    }

    public TicketLogsRequest(String ticketID, Date ticketIssuedDateTime, String consumerTitle, String consumerName,
